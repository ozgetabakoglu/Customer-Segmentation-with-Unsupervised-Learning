...
# The dataset is based on the past shopping behavior of customers who made their last purchases on OmniChannel (both online and offline) in 2020 - 2021.
...
# TASK 1: Preparing the Data
            # 1. Reading flo_data_20K.csv.csv data.
            #2. Choosing the variables to use when segmenting customers. Creation of new variables such as Tenure(Customer's age), Recency(how many days ago he last shopped).
...
# TASK 2: Customer Segmentation with K-Means
            ...
            # 4. Statistical examination of each segment.

# TASK 3: Customer Segmentation with Hierarchical Clustering
            # 1. Determining the optimum number of clusters using the dataframe you standardized in Task 2.
            #2. Build your model and segment your customers
            # 3. Statistical examination of each segment


################################################ ###############
# TASK 1: Scan the dataset and choose the variables to use when segmenting customers.
################################################ ###############
